...
#If mu < 70: then the null hypothesis can not be rejected 
# So true mean is less than 70 our data is not normally distributed.
...
**but before we make a presentation, we need to check the questions and answers together. Also, our time is very short, when can you do it?**
